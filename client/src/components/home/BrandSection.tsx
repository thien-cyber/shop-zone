...
export default function BrandSection({ brands }: BrandSectionProps) {
  ...
  const displayedBrands = hasMore
    ? brands.slice(0, LIMIT - 1)
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-xl mx-auto mb-10">
          ...
          <p className="text-xs text-slate-400 mt-1">
            ShopZone cam kết 100% sản phẩm có nguồn gốc xuất xứ chính thống từ
            các tập đoàn phân phối toàn cầu
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 gap-4 sm:grid-cols-4 lg:grid-cols-8">
          ...
          {/* Thẻ Card thứ 8 giữ chỗ lưới cân bằng tuyệt đối */}
          {hasMore && (
            <Link
              href="/brands"
